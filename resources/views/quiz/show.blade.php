          ...
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
               ...
               <div
                    ...
                    <div class="flex items-center justify-between">
                         <div>
                              ...
                              <p class="text-xs text-slate-400">{{ $answers->count() }} questions</p>
                         </div>
                         <div class="flex items-center space-x-4">
                              ...
                              <button type="submit" form="quiz-form"
                                   class="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-6 py-2 rounded-xl font-bold transition-all duration-200 shadow-lg">
                                   Submit ✓
                              </button>
                         </div>
                    </div>
               ...
               <form id="quiz-form" action="{{ route('quiz.submit', $attempt) }}" method="POST">
                    ...
                    <div class="mt-8 text-center">
                         <button type="submit"
                              class="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-12 py-3 rounded-xl font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-emerald-500/30">
                              Submit Quiz ✓
                         </button>
                    </div>
               </form>
